...
//keep practcing with state inputs and context and i'm sure you'll get it
        ...
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                 <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className="text-left mt-5 font-light text-white md:w-0/12 w-11/12 text-base">
                        Explore the crypto world Send and receive crypto with ease and at low cost.
                    </p>
                    { !currentAccount && (
                        <button 
                        type="button"
                        onClick={ connectWallet }
                        className="flex flex-row justify-center items-cetner my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]">
