...
<nav className='w-full flex md:justify-center justify-between items-center p-4'>
    ...
    <div className='flex relative'> 
            {   toggleMenue 
            ? <AiOutlineClose fontSize={28} className="text-white md-hidden cursor-ponter" onClick={() => setToggleMenue(false)} />
            : <HiMenuAlt4 fontSize={28} className="text-white md-white cursor-ponter onClick" onClick={() => setToggleMenue(true)} />}
            {toggleMenue && ( 
                <ul 
